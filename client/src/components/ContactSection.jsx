    ...
    <section className="contact-section">
      ...
      <div className="contact-card social-card">
        ...
        <div className="social-list">
          {[
            { icon: <InstagramIcon />, label: "Instagram", handle: instagram },
            { icon: <FacebookIcon />,  label: "Facebook",  handle: facebook  },
            { icon: <TiktokIcon />,    label: "TikTok",    handle: tiktok    },
          ].map(s => (
            <div key={s.label} className="social-item">
              <button className="social-btn">{s.icon}</button>
              <div>
